...
export default function GymAdminDashboard() {
  ...
  const kpis = [
    { title: "Active Trainers", value: "12", icon: Users, trend: { value: 2, positive: true }, onClick: () => router.push("/admin/trainers") },
    { title: "Monthly Revenue", value: "$24,580", icon: DollarSign, trend: { value: 15, positive: true }, onClick: () => router.push("/growth") },
    { title: "Classes This Week", value: "48", icon: Calendar, trend: { value: 5, positive: true }, onClick: () => router.push("/admin/classes") },
    { title: "Capacity Fill Rate", value: "87%", icon: TrendingUp, trend: { value: 3, positive: true }, onClick: () => router.push("/admin/classes") },
  ];
